      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 tracking-wide">PREMIER NEIGHBORHOODS</h2>
            <div className="w-16 h-1 bg-[#D4AF37] mx-auto mb-8"></div>
            <p className="text-lg text-gray-300 max-w-3xl mx-auto leading-relaxed">
              Discover the most desirable neighborhoods across Los Angeles and the surrounding metro area with Don Adams
              as your expert guide.
            </p>
          </div>

          <IDXEmbed className="bg-white rounded-lg overflow-hidden shadow-xl" scriptId="idx-home-neighborhoods" />
