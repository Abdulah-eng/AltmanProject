...
import { MapPin, Bed, Bath, Square, Star, Users, TrendingUp, Shield, Waves, Calendar, Anchor } from "lucide-react"
import Link from "next/link"

export default function NewportBeachPage() {
  const neighborhoodInfo = {
    name: "Newport Beach",
    description: "Newport Beach is a prestigious coastal city known for its beautiful harbor, luxury waterfront properties, and upscale lifestyle. This exclusive community offers world-class boating, pristine beaches, and some of the most expensive real estate in Orange County.",
    population: "85,000",
    medianHomePrice: "$2.9M",
    averageDaysOnMarket: "50",
    walkScore: "65",
    crimeRate: "Very Low",
    schools: "Excellent",
    highlights: [
      "World-class harbor and boating",
      "Luxury waterfront properties",
      "Pristine beaches and coastline",
      "Upscale shopping and dining",
      "Excellent schools and safety",
      "Exclusive coastal lifestyle"
    ],
    localAttractions: [
      "Newport Harbor",
      "Balboa Peninsula",
  ...
  const featuredProperties = [
    ...
    {
      id: "13",
      title: "Harbor Front Estate",
      price: 12500000,
      address: "123 Harbor Island, Newport Beach, CA 92660",
      bedrooms: 6,
      bathrooms: 7,
      square_feet: 7200,
      status: "FOR SALE",
    ...
    },
    {
      ...
      price: 6800000,
      address: "456 Balboa Blvd, Newport Beach, CA 92660",
      bedrooms: 4,
      bathrooms: 5,
      square_feet: 4200,
      status: "FOR SALE",
                      ...
                      <div className="w-full h-48 bg-gradient-to-br from-blue-700 to-gray-900 relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center text-white">
                            <Anchor className="w-12 h-12 mx-auto mb-2 text-[#D4AF37]" />
                            <p className="text-sm text-gray-300">Harbor Property</p>
                          </div>
                        </div>
