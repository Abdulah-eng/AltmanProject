...
import { MapPin, Bed, Bath, Square, Star, Users, TrendingUp, Shield, Waves, Calendar, Palette } from "lucide-react"
import Link from "next/link"

export default function LagunaBeachPage() {
  const neighborhoodInfo = {
    name: "Laguna Beach",
    description: "Laguna Beach is a charming coastal city known for its artistic community, stunning coves, and dramatic coastline. This picturesque town offers a unique blend of art galleries, pristine beaches, and luxury hillside homes with breathtaking ocean views.",
    population: "23,000",
    ...
    schools: "Excellent",
    highlights: [
      "Artistic community and galleries",
      "Stunning coves and coastline",
      "Dramatic hillside architecture",
  ...
  const featuredProperties = [
    ...
    {
      id: "15",
      title: "Oceanfront Art Studio",
      price: 9500000,
      address: "123 Coast Hwy, Laguna Beach, CA 92651",
      bedrooms: 3,
      bathrooms: 4,
      square_feet: 3200,
      status: "FOR SALE",
    ...
    {
      id: "16",
      title: "Hillside Art Gallery Home",
      price: 5800000,
      address: "456 Cliff Dr, Laguna Beach, CA 92651",
      bedrooms: 4,
      bathrooms: 5,
      square_feet: 3800,
      status: "FOR SALE",
                      ...
                      <div className="w-full h-48 bg-gradient-to-br from-blue-700 to-gray-900 relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center text-white">
                            <Palette className="w-12 h-12 mx-auto mb-2 text-[#D4AF37]" />
                            <p className="text-sm text-gray-300">Art Villa</p>
                          </div>
                        </div>
