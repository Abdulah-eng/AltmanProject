...
export default function SantaMonicaPage() {
  const neighborhoodInfo = {
    name: "Santa Monica",
    description: "Santa Monica is a vibrant beachfront city known for its iconic pier, Third Street Promenade, and perfect blend of urban sophistication and beach lifestyle. This coastal community offers excellent dining, shopping, and entertainment options.",
    population: "93,000",
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-gray-800 rounded-lg p-6 text-center">
                  ...
                  <div className="text-gray-400">Walk Score</div>
                </div>
                <div className="bg-gray-800 rounded-lg p-6 text-center">
                      ...
                      <div className="w-full h-48 bg-gradient-to-br from-blue-700 to-gray-900 relative overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="text-center text-white">
                            ...
                            <p className="text-sm text-gray-300">Beach Property</p>
                          </div>
                        </div>
